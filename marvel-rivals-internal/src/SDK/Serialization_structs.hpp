...
public:
	...
	struct FSoftClassPath                         ClassPath;                                         // 0x0090(0x0028)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSoftObjectPath                        ObjectPath;                                        // 0x00B8(0x0028)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FStructSerializerObjectTestStruct      Objects;                                           // 0x0038(0x00E0)(NativeAccessSpecifierPublic)
	uint8                                         Pad_118[0x8];                                      // 0x0118(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FStructSerializerBuiltinTestStruct     Builtins;                                          // 0x0120(0x00D0)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FStructSerializerArrayTestStruct       Arrays;                                            // 0x01F0(0x0060)(NativeAccessSpecifierPublic)
	struct FStructSerializerMapTestStruct         Maps;                                              // 0x0250(0x0140)(NativeAccessSpecifierPublic)
	struct FStructSerializerSetTestStruct         Sets;                                              // 0x0390(0x0140)(NativeAccessSpecifierPublic)
	struct FStructSerializerLWCTypesTest          LWCTypes;                                          // 0x04D0(0x0360)(NativeAccessSpecifierPublic)
};
