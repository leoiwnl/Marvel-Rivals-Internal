...
class UCompositingPickerAsyncTask* UCompositingPickerAsyncTask::OpenCompositingPicker(class UTextureRenderTarget2D* PickerTarget_0, class UTexture* DisplayImage, const class FText& WindowTitle, const bool bAverageColorOnDrag, const bool bUseImplicitGamma)
{
	...
	Parms.PickerTarget_0 = PickerTarget_0;
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class APlayerCameraManager*             PlayerCameraManager_0                                  (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class APlayerCameraManager* UComposurePlayerCompositingTarget::SetPlayerCameraManager(class APlayerCameraManager* PlayerCameraManager_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.PlayerCameraManager_0 = PlayerCameraManager_0;
...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// class UTexture*                         DisplayTexture_0                                       (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UComposureCompositingTargetComponent::SetDisplayTexture(class UTexture* DisplayTexture_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.DisplayTexture_0 = DisplayTexture_0;
