...
{
public:
	uint8                                         Pad_148[0x290];                                    // 0x0148(0x0290)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_148[0x340];                                    // 0x0148(0x0340)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_148[0x170];                                    // 0x0148(0x0170)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2B8[0xC8];                                     // 0x02B8(0x00C8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2B8[0xE8];                                     // 0x02B8(0x00E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_148[0xC0];                                     // 0x0148(0x00C0)(Fixing Struct Size After Last Property [ Dumper-7 ])
