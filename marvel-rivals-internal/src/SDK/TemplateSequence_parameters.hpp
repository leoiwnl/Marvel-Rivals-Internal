...
public:
	...
	struct FMinimalViewInfo                       ReturnValue;                                       // 0x0010(0x0A50)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FPostProcessSettings                   OutPPSettings;                                     // 0x0010(0x0970)(Parm, OutParm, NativeAccessSpecifierPublic)
	float                                         OutPPBlendWeight;                                  // 0x0980(0x0004)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0984(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_985[0xB];                                      // 0x0985(0x000B)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
