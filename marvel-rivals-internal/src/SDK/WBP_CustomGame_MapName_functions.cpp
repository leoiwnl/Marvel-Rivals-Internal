...
// Function WBP_CustomGame_MapName.WBP_CustomGame_MapName_C.测试地图名
// (BlueprintCallable, BlueprintEvent)

void UWBP_CustomGame_MapName_C::测试地图名()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_CustomGame_MapName_C", "测试地图名");
