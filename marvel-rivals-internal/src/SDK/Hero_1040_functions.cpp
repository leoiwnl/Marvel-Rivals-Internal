...
void UAbility_104041::OnTargetTranslatedByPortal(class AMarvelBaseCharacter* Character, class APortalViewActor* Portal)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ability_104041", "OnTargetTranslatedByPortal");

	Params::Ability_104041_OnTargetTranslatedByPortal Parms{};
...
struct FVector UMisterFantasticAnimInstance::GetTracedLocation()
{
	static class UFunction* Func = nullptr;
