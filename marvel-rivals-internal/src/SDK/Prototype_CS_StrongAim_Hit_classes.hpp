...
// Package: Prototype_CS_StrongAim_Hit
...
// BlueprintGeneratedClass Prototype_CS_StrongAim_Hit.Prototype_CS_StrongAim_Hit_C
// 0x0000 (0x02B0 - 0x02B0)
class UPrototype_CS_StrongAim_Hit_C final : public ULegacyCameraShake
{
public:
