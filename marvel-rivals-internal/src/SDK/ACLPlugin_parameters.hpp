...
public:
	...
	class UAnimationCompressionLibraryDatabase*   DatabaseAsset;                                     // 0x0028(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
