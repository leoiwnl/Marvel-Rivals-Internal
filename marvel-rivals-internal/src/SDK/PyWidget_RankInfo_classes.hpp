...
public:
	...
	TMulticastInlineDelegate<void()>              OnStarPlayAnimFinish;                              // 0x0610(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
