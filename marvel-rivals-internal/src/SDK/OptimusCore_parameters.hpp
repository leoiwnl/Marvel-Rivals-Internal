...
{
public:
	class FName                                   InTriggerGraphName;                                // 0x0000(0x000C)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct FOptimusDataTypeRef                    InDataTypeRef;                                     // 0x0000(0x0014)(Parm, NoDestructor, NativeAccessSpecifierPublic)
