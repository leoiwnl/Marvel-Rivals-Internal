...
enum class EFieldFilterType : uint8
{
	...
	Field_Filter_X20Chaos                    = 6,
	Field_Filter_X20ChaosWithChildren        = 7,
	Field_Filter_X20ChaosWithoutGrouped      = 8,
	Field_Filter_Max                         = 9,
	Field_Filter_Max_0                       = 10,
};
...
enum class EFieldObjectType : uint8
{
	...
	Field_Object_X20Chaos                    = 4,
	Field_Object_All                         = 5,
	Field_Object_Max                         = 6,
	Field_Object_Max_0                       = 7,
};
...
enum class EFieldPositionType : uint8
{
	...
	Field_Position_ChildAABB                 = 2,
	Field_Position_ChildConvex               = 3,
	Field_Position_Max                       = 4,
	Field_Position_Max_0                     = 5,
};
...
enum class EFieldPhysicsType : uint8
{
	...
	Field_AngularVelocityOfRevolution        = 20,
	Field_PhysicsType_Max                    = 21,
};
