...
// Package: WBP_HeroStory_Content_Unit
...
// WidgetBlueprintGeneratedClass WBP_HeroStory_Content_Unit.WBP_HeroStory_Content_Unit_C
// 0x0018 (0x03D0 - 0x03B8)
class UWBP_HeroStory_Content_Unit_C final : public UUserWidget
{
public:
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"WBP_HeroStory_Content_Unit_C">();
	}
	static class UWBP_HeroStory_Content_Unit_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UWBP_HeroStory_Content_Unit_C>();
	}
};
