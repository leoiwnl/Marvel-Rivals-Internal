...
{
public:
	struct FSoftClassPath                         InBurnInClass;                                     // 0x0000(0x0028)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
struct LevelSequenceActor_SetIgnoreNonBoundObjects final
{
public:
