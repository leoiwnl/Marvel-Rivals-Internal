...
// PythonFunction PyWidget_CommonItem_V2.PyWidget_CommonItem.OnAnimationsDisabled
// (BlueprintCosmetic, Native, Event, Protected, BlueprintCallable, BlueprintEvent)

void UPyWidget_CommonItem::OnAnimationsDisabled()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_CommonItem", "OnAnimationsDisabled");
...
void UPyWidget_CommonItem::SetIsFocusable(bool IsFocusable)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("PyWidget_CommonItem", "SetIsFocusable");

	Params::PyWidget_CommonItem_SetIsFocusable Parms{};
