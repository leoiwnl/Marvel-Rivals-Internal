...
// Function GeometryCache.GeometryCacheActor.CheckVisibility
// (Final, Native, Private)

void AGeometryCacheActor::CheckVisibility()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GeometryCacheActor", "CheckVisibility");
