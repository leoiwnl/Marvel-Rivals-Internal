...
public:
	...
	void GetOwnedGameplayTags_Reset(struct FGameplayTagContainer* TagContainer) const;
...
public:
	...
	class UEditableGameplayTagQueryExpression*    RootExpression;                                    // 0x0050(0x0008)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct FGameplayTagContainer                  Tags;                                              // 0x0030(0x0068)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                         Pad_30[0x170];                                     // 0x0030(0x0170)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class FName, struct FGameplayTagSource>  TagSources;                                        // 0x01A0(0x0050)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_1F0[0x90];                                     // 0x01F0(0x0090)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UDataTable*>                     GameplayTagTables;                                 // 0x0280(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
...
public:
	...
	bool                                          AllowEditorTagUnloading;                           // 0x0053(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          AllowGameTagUnloading;                             // 0x0054(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          FastReplication;                                   // 0x0055(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
