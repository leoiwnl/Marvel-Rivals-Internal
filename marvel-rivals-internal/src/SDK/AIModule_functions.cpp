...
class FString UBTNode::GetBTNodeDescription() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BTNode", "GetBTNodeDescription");

	Params::BTNode_GetBTNodeDescription Parms{};
...
// Function AIModule.BlackboardComponent.ClearAllValues
// (Final, RequiredAPI, Native, Public, BlueprintCallable)

void UBlackboardComponent::ClearAllValues()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BlackboardComponent", "ClearAllValues");
