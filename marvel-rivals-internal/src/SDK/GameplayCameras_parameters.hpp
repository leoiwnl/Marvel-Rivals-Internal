...
public:
	...
	struct FMinimalViewInfo                       POV;                                               // 0x0010(0x0A50)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FMinimalViewInfo                       ModifiedPOV;                                       // 0x0A60(0x0A50)(Parm, OutParm, NativeAccessSpecifierPublic)
};
