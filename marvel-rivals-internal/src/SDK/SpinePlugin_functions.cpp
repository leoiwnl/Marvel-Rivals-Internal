...
// Function SpinePlugin.SpineWidget.CheckState
...
void USpineWidget::CheckState()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("SpineWidget", "CheckState");
...
// Function SpinePlugin.SpineWidget.DisposeState
// (Native, Public, BlueprintCallable)
...
void USpineWidget::DisposeState()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("SpineWidget", "DisposeState");
